...
BACK_MAIN = switch("caregiver_patient1_main", "switch-to-caregiver-patient1-main")
...
MENU_DEFINITIONS = {
    ...
    "patient1_main": {
        "menu": {
            ...
            "areas": [
                area(TOP[0], switch("caregiver_patient1_today_tasks", "switch-to-caregiver-today-tasks")),
                area(TOP[1], switch("caregiver_patient1_medication_records", "switch-to-caregiver-medication-records")),
                area(TOP[2], switch("caregiver_patient1_calendar", "switch-to-caregiver-calendar")),
                area(BOTTOM[0], switch("caregiver_patient1_prescription_medication", "switch-to-caregiver-prescription")),
                area(BOTTOM[1], switch("caregiver_patient1_report_issue", "switch-to-caregiver-report-issue")),
                area(BOTTOM[2], switch("caregiver_patient1_sos", "switch-to-caregiver-sos")),
    ...
    "patient1_today_tasks": six_menu(
        ...
        "caregiver_patient1_today_tasks_menu.jpg", "caregiver_patient1_today_tasks",
    ),
    "patient1_medication_records": six_menu(
        ...
        "caregiver_patient1_medication_records_menu.jpg", "caregiver_patient1_medication_records",
    ),
    "patient1_calendar": six_menu(
        ...
        "caregiver_patient1_calendar_menu.jpg", "caregiver_patient1_calendar",
    ),
    "patient1_prescription_medication": six_menu(
        "Caregiver - Photograph Prescription",
        [
            {"type": "camera", "label": "Photograph Prescription"},
            switch("caregiver_patient1_medication_plan", "switch-to-caregiver-medication-plan"),
        ...
        "caregiver_patient1_prescription_medication_menu.jpg", "caregiver_patient1_prescription_medication",
    ),
    "patient1_medication_plan": six_menu(
        ...
        [
            ...
            switch("caregiver_patient1_prescription_medication", "back-to-caregiver-prescription"),
        ],
        "caregiver_patient1_medication_plan_menu.jpg", "caregiver_patient1_medication_plan",
    ),
    "patient1_report_issue": six_menu(
        ...
        "caregiver_patient1_report_issue_menu.jpg", "caregiver_patient1_report_issue",
    ),
    "patient1_sos": {
        "menu": {
            "size": SIZE,
