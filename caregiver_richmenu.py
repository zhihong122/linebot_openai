...
MENU_DEFINITIONS = {'main': {'menu': {'size': {'width': 2500, 'height': 1686},
                   'selected': True,
                   'name': '看護患者選擇',
                   'chatBarText': '查看更多資訊',
          ...
          'image': 'caregiver_patient_selector_menu.png',
          'alias': 'caregiver_main'},
 'patient1_main': {'menu': {'size': {'width': 2500, 'height': 1686},
                            'selected': True,
                            'name': '看護患者1主選單',
                            'chatBarText': '查看更多資訊',
                            'areas': [{'bounds': {'x': 0, 'y': 0, 'width': 833, 'height': 843},
                   ...
                   'image': 'caregiver_patient1_main_menu.png',
                   'alias': 'caregiver_patient1_main'},
 'patient1_today_tasks': {'menu': {'size': {'width': 2500, 'height': 1686},
                                   'selected': True,
                                   'name': '看護患者1今日任務',
                                   'chatBarText': '返回患者1',
                                   'areas': [{'bounds': {'x': 1663,
                                              ...
                                              'action': {'type': 'richmenuswitch',
                                                         'richMenuAliasId': 'caregiver_patient1_main',
                                                         'data': 'switch-to-caregiver-patient1-main'}}]},
                          'image': 'caregiver_patient1_today_tasks_menu.png',
                          'alias': 'caregiver_patient1_today_tasks'},
 'patient1_checklist': {'menu': {'size': {'width': 2500, 'height': 1686},
                                 'selected': True,
                                 ...
                                 'areas': [{'bounds': {'x': 1663,
                                            ...
                                            'action': {'type': 'richmenuswitch',
                                                       'richMenuAliasId': 'caregiver_patient1_main',
                                                       'data': 'switch-to-caregiver-patient1-main'}}]},
                        'image': 'caregiver_patient1_checklist_menu.png',
                        'alias': 'caregiver_patient1_checklist'},
 'patient1_report_issue': {'menu': {'size': {'width': 2500, 'height': 1686},
                                    'selected': True,
                                    'name': '看護患者1異常回報',
                                    'chatBarText': '返回患者1',
                                    'areas': [{'bounds': {'x': 1663,
                                               ...
                                               'action': {'type': 'richmenuswitch',
                                                          'richMenuAliasId': 'caregiver_patient1_main',
                                                          'data': 'switch-to-caregiver-patient1-main'}}]},
                           'image': 'caregiver_patient1_report_issue_menu.png',
                           'alias': 'caregiver_patient1_report_issue'},
 'sos_contact': {'menu': {'size': {'width': 2500, 'height': 1686},
                          'selected': True,
                          'name': '看護SOS聯絡',
                          'chatBarText': '返回主選單',
                          'areas': [{'bounds': {'x': 1663, 'y': 843, 'width': 837, 'height': 843},
                                     'action': {'type': 'richmenuswitch',
                                                'richMenuAliasId': 'caregiver_main',
                                                'data': 'switch-to-caregiver-main'}}]},
                 'image': 'caregiver_sos_contact_menu.png',
