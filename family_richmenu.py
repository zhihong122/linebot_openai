...
MENU_DEFINITIONS = {
    ...
    "monitoring": {
        "menu": {
            ...
            "areas": [
                {"bounds": {"x": 35, "y": 251, "width": 798, "height": 665},
                 "action": {"type": "postback", "label": "今日狀態",
                            "data": "action=family_monitor_today_status",
                            "displayText": "今日狀態"}},
                {"bounds": {"x": 855, "y": 251, "width": 827, "height": 671},
                 "action": {"type": "postback", "label": "漏服通知",
                            "data": "action=family_monitor_missed",
                            "displayText": "漏服通知"}},
                {"bounds": {"x": 1701, "y": 254, "width": 772, "height": 665},
                 "action": {"type": "postback", "label": "緊急通知",
                            "data": "action=family_monitor_emergency",
                            "displayText": "緊急通知"}},
                {"bounds": {"x": 38, "y": 935, "width": 792, "height": 740},
                 "action": {"type": "postback", "label": "不舒服紀錄",
                            "data": "action=family_monitor_discomfort",
                            "displayText": "不舒服紀錄"}},
                {"bounds": {"x": 852, "y": 941, "width": 826, "height": 741},
                 "action": {"type": "postback", "label": "服藥率統計",
                            "data": "action=family_monitor_adherence",
                            "displayText": "服藥率統計"}},
                {"bounds": {"x": 1698, "y": 935, "width": 775, "height": 744},
