...
MENU_DEFINITIONS = {
    ...
    "medication_report": {
        "menu": {
            ...
            "areas": [
                {"bounds": {"x": 0, "y": 0, "width": 833, "height": 843},
                 "action": {"type": "postback", "label": "早餐已服",
                            "data": "action=elder_taken_breakfast",
                            "displayText": "早餐已服"}},
                {"bounds": {"x": 834, "y": 0, "width": 833, "height": 843},
                 "action": {"type": "postback", "label": "午餐已服",
                            "data": "action=elder_taken_lunch",
                            "displayText": "午餐已服"}},
                {"bounds": {"x": 1663, "y": 0, "width": 837, "height": 843},
                 "action": {"type": "postback", "label": "晚餐已服",
                            "data": "action=elder_taken_dinner",
                            "displayText": "晚餐已服"}},
                {"bounds": {"x": 0, "y": 843, "width": 833, "height": 843},
                 "action": {"type": "postback", "label": "睡前已服",
                            "data": "action=elder_taken_bedtime",
                            "displayText": "睡前已服"}},
                {"bounds": {"x": 834, "y": 843, "width": 833, "height": 843},
                 "action": {"type": "postback", "label": "今日紀錄",
