...
MENU_DEFINITIONS = {'main': {'menu': {'size': {'width': 2500, 'height': 1686},
          ...
          'image': 'elder_main_menu.png',
          'alias': 'elder_main'},
 'today_medication': {'menu': {'size': {'width': 2500, 'height': 1686},
                               'selected': True,
                               'name': '長者今日用藥',
                               'chatBarText': '返回主選單',
                               'areas': [{'bounds': {'x': 1663,
                      ...
                      'image': 'elder_today_medication_menu.png',
                      'alias': 'elder_today_medication'},
 'my_medication': {'menu': {'size': {'width': 2500, 'height': 1686},
                            'selected': True,
                            'name': '長者我的藥物',
                            'chatBarText': '返回主選單',
                            'areas': [{'bounds': {'x': 1663, 'y': 843, 'width': 837, 'height': 843},
                                       'action': {'type': 'richmenuswitch',
                                                  'richMenuAliasId': 'elder_main',
                                                  'data': 'switch-to-elder-main'}}]},
                   'image': 'elder_my_medication_menu.png',
                   'alias': 'elder_my_medication'},
 'medication_report': {'menu': {'size': {'width': 2500, 'height': 1686},
                                'selected': True,
                                'name': '長者用藥回報',
                                'chatBarText': '返回主選單',
                                'areas': [{'bounds': {'x': 1663,
                                           ...
                                           'action': {'type': 'richmenuswitch',
                                                      'richMenuAliasId': 'elder_main',
                                                      'data': 'switch-to-elder-main'}}]},
                       'image': 'elder_medication_report_menu.png',
                       'alias': 'elder_medication_report'},
 'discomfort': {'menu': {'size': {'width': 2500, 'height': 1686},
                         'selected': True,
                         'name': '長者身體不適',
                         'chatBarText': '返回主選單',
                         'areas': [{'bounds': {'x': 1663, 'y': 843, 'width': 837, 'height': 843},
                                    'action': {'type': 'richmenuswitch',
                                               'richMenuAliasId': 'elder_main',
                                               'data': 'switch-to-elder-main'}}]},
                'image': 'elder_discomfort_menu.png',
 ...
 'calendar': {'menu': {'size': {'width': 2500, 'height': 1686},
                       ...
                       'areas': [{'bounds': {'x': 1663, 'y': 843, 'width': 837, 'height': 843},
                                  'action': {'type': 'richmenuswitch',
                                             'richMenuAliasId': 'elder_main',
                                             'data': 'switch-to-elder-main'}}]},
              'image': 'elder_calendar_menu.png',
              'alias': 'elder_calendar'},
 'sos': {'menu': {'size': {'width': 2500, 'height': 1686},
                  'selected': True,
                  'name': '長者SOS',
                  'chatBarText': '返回主選單',
                  'areas': [{'bounds': {'x': 1663, 'y': 843, 'width': 837, 'height': 843},
